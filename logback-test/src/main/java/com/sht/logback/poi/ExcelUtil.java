...
public class ExcelUtil<T>
{
    ...
    public static final String baseDownloadPath = "D:\\test\\download";
    ...
    public void setCellVo(Object value, Excel attr, Cell cell)
    {
        ...
        else if (Excel.ColumnType.IMAGE == attr.cellType())
        {
            ...
            {
                byte[] data = null;//ImageUtils.getImage(imagePath);
    ...
    {
        return "DictUtils";//DictUtils.getDictLabel(dictType, dictValue, separator);
    }
    ...
    {
        return "DictUtils";//DictUtils.getDictValue(dictType, dictLabel, separator);
    }
