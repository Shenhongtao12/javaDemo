...
import com.sht.common.param.MultipartFileParam;
import com.sht.common.service.StorageService;
import com.sht.common.utils.Constants;
import com.sht.common.vo.ResultStatus;
import com.sht.common.vo.ResultVo;
...
public class IndexController {
    ...
    public Object checkFileMd5(String md5) throws IOException {
        ...
        String value = redisTemplate.opsForValue().get(Constants.FILE_MD5_KEY + md5).toString();
        if (processing) {
